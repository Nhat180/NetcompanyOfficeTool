          ...
          leading: IconButton(
            ...
            onPressed: () async {
              if (titleController.text == widget.draft.title &&
                ...
                if (titleController.text != widget.draft.title) {
                  await FirebaseFirestore.instance.collection("draftSuggestions")
              ...
              children: [
                            ...
                            SizedBox(
                              child: Text.rich(
                                TextSpan(
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(text: 'IDEAS', style: TextStyle(
                ...
                Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance.collection("typeSuggestions").snapshots(),
                          ...
                          return Row(
                            children: <Widget>[
                              const Padding(
                                ...
                                child: Icon(Icons.lightbulb, color: Color(0xff0f2147),),
                              ),
                    ...
                    onPressed: () async {
                      if (titleController.text == '' || titleController.text.isEmpty
                        ...
                        Navigator.pushReplacement(context, MaterialPageRoute(
                            builder: (context) => NavigationScreen(index: suggestionScreen,)));
                      }
                    },
                  ),
                ),
